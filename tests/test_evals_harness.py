...
def test_only_representative_routing_cases_repeat_by_default():
    ...
    assert repeated_ids == {
        ...
        "week06.supervisor.year_anchor_on_followup",
        "week06.supervisor.no_slot_alternate_phrasing",
        "week06.supervisor.save_after_coordination",
        "week06.supervisor.rerouted_confirmation",
        "week06.nana.confirmed_group_schedule_save",
        "week06.nana.heldout_personal_lunch_save",
        "week06.kana.slot_without_duration",
        "week06.kana.relative_week_range",
...
class TestWeek06RoutingCaseDataset:
    ...
    def test_total_runs_match_the_planned_budget(self):
        """대표 22개는 3회, 나머지 7개는 1회 = 73회입니다."""

        cases = cases_week06_routing.WEEK06_ROUTING_CASES

        assert sum(case.get("repeats", 1) for case in cases) == 73
