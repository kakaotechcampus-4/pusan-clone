...
def _personal_schedules_for_current_scope() -> list[dict[str, Any]]:
    ...
    temporary_schedules = [
        ...
        if _schedule_scope(schedule) == current_session_scope() and schedule.get("id") not in saved_ids
    ]
