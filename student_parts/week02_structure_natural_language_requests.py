...
class StructuredRequest(BaseModel):
    ...
    date: str | None = Field(default=None, description=f"요청이 예정된 날짜")
    ...
    return [
        *week01_prompt_parts(),
        ...
        (
            ...
            f"[다음주, 2주 뒤, 3주 뒤] 등 요일을 지정하지 않고 모호한 표현으로 들어오면 가장 일반적으로 계산합니다. ex) 다음주: {current_app_date_iso()}+7일 뒤, 2주 뒤: {current_app_date_iso()}+14일 뒤, 한달 뒤에: {current_app_date_iso()}+30일 뒤 등"
