...
class StructuredRequest(BaseModel):
    ...
    kind: RequestKind = Field(description="요청의 종류를 나타내는 필드입니다.")
    ...
    members: list[str] = Field(default_factory=list, description="사용자가 요청한 일정의 참여자 또는 멤버 정보를 기록합니다. 여럿이 될 수 있습니다.")
