...
def kana_prompt_parts() -> list[str]:
    ...
    return [
        ...
        (
            ...
            "그 문장이 사용자에게 그대로 전달될 수 있으니 '주차', 'Week', '과제' 같은 내부 용어는 쓰지 않고, "
        ...
        [
            *week06_prompt_parts(),
            ...
            (
                ...
                "사용자에게 보이는 답변에는 '주차', 'Week', '과제', 'tool', 'agent' 같은 내부 용어를 쓰지 않는다. "
                "아직 처리할 수 없는 일은 '이번 범위 밖'이라고 하지 말고 '아직 지원하지 않아요'처럼 사용자 입장의 말로 안내한다."
            )
        ]
    )
